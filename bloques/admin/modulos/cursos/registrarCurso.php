...
src = "../../../.././alertas/existenteCurso.js">
    ...
    try {
        ...
        $sentencia = $conexion->prepare("INSERT INTO cursos
                VALUES(null, :nombre_curso, :agencia)");
...
<?php include("../../../../cabecera_pie_admin/cabecera.php");?>
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Añadir un nuevo Curso</h3>
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            <form method="post">
                                                <div class="mb-3"><label class="form-label"><strong>Nombre del curso</strong><br></label></div><input class="form-control" type="text" name="nombre_curso" style="padding-right: 12px;margin-right: -13px;margin-bottom: 5px;margin-top: -12px;" required="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 col-lg-12">
                                        ...
                                        <a class="btn btn-danger btn-sm" role="button" style="margin-left: 11px;" href="cursos.php<?php echo($url_fin) ?>">Cancelar</a></div>
                                        <div class="mb-3"></div>
                                    </form>
                                </div>
                            </div>
